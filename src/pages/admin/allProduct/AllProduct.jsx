    ...
    return (
        <Layout>
            <div className="py-8">
                {/* Heading */}
                <div className="">
                    <h1 className="text-center mb-5 text-2xl font-semibold text-[#493628] hover:text-[#D6C0B3]">All Products</h1>
                </div>
                                    ...
                                    <div key={index} className="p-4 w-full md:w-1/4">
                                        <div className="h-full border border-black rounded-xl overflow-hidden shadow-md cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-lg">
                                            ...
                                            <div className="p-6">
                                                ...
                                                <h2 className="tracking-widest text-xl title-font font-large text-black mb-3">
                                                    {description}
                                                </h2>
                                                <h1 className="title-font text-lg font-bold text-gray-900 mb-3">
                                                    ${price}
